      ...
      {/* {count.map(coo => coo)} */}
      {
        ...
        (<div className='flex flex-row md:flex-col '>
          ...
          <div className='mr-[15rem]'>
            <div>
              <div className='text-md '>Your cart</div>
              <div className='text-2xl font-bold text-red text-green-600'>Summary</div>
              <p>
                <span>Total Items : {cart.length}</span>
              </p>
            </div>
            <div className='mt-[400px] md:mt-[40px]'>
              <p className='font-bold'>Total Amount : ${totalAmount}</p>
              <button className='bg-emerald-700	text-white px-[5rem] py-2 rounded-[5px] mt-2'>
                CheckOut now
              </button>
            </div>
          </div>
